...
import { changePassword, loadDoctor } from "../../actions/doctor";
...
import stylesHere from "./ChangePassword.module.css";

const ChangePassword = ({ changePassword, loadDoctor, email, alerts }) => {
  ...
  return (
    <div className="universalContainer">
      <h1 className="universalTitle">Doctor | Change Password</h1>
...
export default connect(mapStateToProps, { changePassword, loadDoctor })(ChangePassword);
